...
class TestQuizCreateEndpoint:
    ...
    def test_create_quiz(self):
        ...
        response: Response = self.client.post('/api/v1/quizzes/', payload)
    ...
    def test_anon_cant_create_quiz(self):
        ...
        response: Response = anon_client.post('/api/v1/quizzes/', payload)
...
class TestQuizUpdateEndpoint:
    ...
    def test_update_quiz(self):
        ...
        response: Response = self.client1.put(f'/api/v1/quizzes/{self.quiz.id}/', payload)
    ...
    def test_update_nonexistent_quiz(self):
        ...
        response: Response = self.client1.put('/api/v1/quizzes/99999/', payload)
    ...
    def test_anon_cant_update_quiz(self):
        ...
        anon_client = APIClient()
        response: Response = anon_client.put(f'/api/v1/quizzes/{self.quiz.id}/', payload)
    ...
    def test_another_user_cant_update_quiz(self):
        ...
        response: Response = self.client2.put(f'/api/v1/quizzes/{self.quiz.id}/', payload)
